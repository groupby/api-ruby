...
module Groupby
  class TestJsonDeserialize < Minitest::Test
    ...
    def test_deserialize_results
      assert_equal(Object::RESULTS, Model::Results.from_json(Json::RESULTS))
    end

    def test_deserialize_refs_result
      assert_equal(Object::REFINEMENTS_REQUEST, Model::RefinementsResult.from_json(Json::RESULTS))
    end
